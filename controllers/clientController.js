...
const create = async (req, res) => {
  ...
  try {
    const {
      ...
      country, phone_country_code, phone_number, website, ein_number,
      currency, currency_symbol, disable_online_payment,
      status
    } = req.body;
    ...
    const [result] = await connection.execute(
      `INSERT INTO clients (
        ...
        phone_country_code, phone_number, website, ein_number,
      ...
      [
        ...
        website, ein_number, currency || 'USD',
