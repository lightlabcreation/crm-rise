...
(1, 'TASK-1001', 'Design Homepage', 'Create new homepage design', 1, '2024-12-01', '2024-12-15', 'In-Progress', 'High', 1),
(1, 'TASK-1002', 'Develop Contact Form', 'Build contact form functionality', 1, '2024-12-10', '2024-12-20', 'Backlog', 'Medium', 1),
(1, 'TASK-1003', 'Test Responsive Design', 'Test on multiple devices', 1, '2024-12-20', '2024-12-25', 'Backlog', 'High', 1),
(2, 'TASK-1004', 'Setup Development Environment', 'Configure iOS and Android dev tools', 2, '2024-12-15', '2024-12-22', 'Done', 'High', 1),
(2, 'TASK-1005', 'Create API Endpoints', 'Develop backend APIs', 2, '2024-12-20', '2025-01-05', 'In-Progress', 'High', 1);
...
(1, 2, 'update', 'tasks', 1, '{"status": "Backlog"}', '{"status": "In-Progress"}', '127.0.0.1'),
